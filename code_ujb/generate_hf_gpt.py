...
if __name__ == "__main__":
    ...
    assert args.batch_size == 1, "Batch size must be 1 for correct log probabilities calculation. (The developer of the script is either lazy or not skilled enough to handle batch size > 1 logprobs extraction!)"
    run_generate(
