...
def run_evaluate(
    ...
    #################### All they do in the commented code below is postprocess inputs, outputs and raw_outputs.
    #################### Inputs and raw outputs are used to compute some metrics that are not relevant for us.
    #################### Outputs are already post processed in the generation phase. See code_ujb/generate.py on ION.
